...
return [
    ...
    */
    ...
    'confirmed' => 'Новый :attribute не совпадает с подтвержденным',
    ...
    'password' => [
        ...
        'mixed' => 'Пароль должен содержать хотя бы одну букву верхнего регистра и одну букву нижнего регистра',
        'numbers' => 'Пароль должен содержать хотя бы одну цифру',
        'symbols' => 'Пароль должен содержать хотя бы один символ',
//        'uncompromised' => 'The given :attribute has appeared in a data leak. Please choose a different :attribute.',
        'uncompromised' => 'Введенный пароль не является безопасным. Пожалуйста, придумайте другой пароль',
    ],
